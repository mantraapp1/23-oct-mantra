        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-[var(--foreground-secondary)] mt-1">Sign in to continue reading</p>
                </div>
                ...
                <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 text-[var(--foreground-secondary)]">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-[var(--card)] text-[var(--foreground-secondary)]">
                                or continue with
                            </span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-3 border border-[var(--border)] rounded-lg font-medium text-[var(--foreground)] hover:bg-[var(--background-secondary)] transition-colors flex items-center justify-center gap-2"
                    >
