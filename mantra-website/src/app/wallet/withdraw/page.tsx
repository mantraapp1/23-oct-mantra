    ...
    if (success) {
        return (
            <div className="max-w-md mx-auto px-4 py-20 text-center font-inter">
                ...
                <Link href="/wallet" className="text-sky-600 font-semibold hover:underline">
                    Back to Wallet
                </Link>
            </div>
        );
    ...
    return (
        <div className="max-w-md mx-auto px-4 py-8 font-inter text-slate-800">
            ...
            <div className="flex items-center gap-4 mb-8">
                <Link href="/wallet" className="p-2 -ml-2 rounded-lg hover:bg-slate-100 transition-colors">
