    ...
    'inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                ...
                pink: 'bg-pink-100 text-pink-700 dark:bg-pink-500/15 dark:text-pink-200 border-transparent',
                orange: 'bg-orange-100 text-orange-700 dark:bg-orange-500/15 dark:text-orange-200 border-transparent',
                teal: 'bg-teal-100 text-teal-700 dark:bg-teal-500/15 dark:text-teal-200 border-transparent',
                cyan: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-500/15 dark:text-cyan-200 border-transparent',
                lime: 'bg-lime-100 text-lime-700 dark:bg-lime-500/15 dark:text-lime-200 border-transparent',
                violet: 'bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-200 border-transparent',
                fuchsia: 'bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/15 dark:text-fuchsia-200 border-transparent',
            },
            appearance: {
                default: '',
                light: '',
