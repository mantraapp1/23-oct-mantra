...
import type { ReviewWithUser } from '@/lib/services/reviewService';
        ...
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            {isLoading ? (
                ...
                <div className="text-center py-8 text-sm text-slate-500 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                    No reviews yet. {currentUser ? 'Be the first to review!' : <Link to="/login" className="text-amber-600 font-semibold hover:underline">Log in</Link>}
                </div>
            )}
