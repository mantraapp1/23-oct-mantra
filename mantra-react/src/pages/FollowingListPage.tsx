...
export default function FollowingListPage() {
    ...
    const loadData = async () => {
        try {
            ...
            if (followData) {
                setFollowing(followData.map((f: any) => f.following).filter(Boolean));
            }
                ...
                <div className="w-full">
                    {following.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-background">
                            ...
                            <h3 className="font-bold text-foreground mb-1">Not following anyone</h3>
                            <p className="text-muted-foreground text-sm">When this user follows someone, they'll appear here</p>
                        </div>
                    )}
                </div>
            </div>
