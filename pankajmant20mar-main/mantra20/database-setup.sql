...
INSERT INTO storage.buckets (id, name, public) VALUES ('profile_pictures', 'Profile Pictures', true) ON CONFLICT (id) DO NOTHING;
INSERT INTO storage.buckets (id, name, public) VALUES ('novel_covers', 'Novel Covers', true) ON CONFLICT (id) DO NOTHING;
